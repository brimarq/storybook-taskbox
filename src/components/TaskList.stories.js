 ...
 * expected by both components is preserved.
 */
 ...
 * we’re using a decorator `key` on the default export to add some `padding` 
 * around the rendered component. They can also be used to wrap stories in 
